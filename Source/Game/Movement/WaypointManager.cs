...
namespace Game
{
    public sealed class WaypointManager : Singleton<WaypointManager>
    {
        ...
        public void Load()
        {
            ...
            //                                          0    1         2           3          4            5           6        7
            using var result = DB.World.Query("SELECT id, point, position_x, position_y, position_z, orientation, move_type, delay FROM waypoint_data ORDER BY id, point");
    ...
    public class WaypointNode
    {
        ...
        public WaypointNode(int _id, float _x, float _y, float _z, float? _orientation = null, uint _delay = 0)
        {
            id = _id;
            x = _x;
            y = _y;
