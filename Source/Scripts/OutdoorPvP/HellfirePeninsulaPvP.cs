...
namespace Scripts.OutdoorPVP.HellfirePeninsula
{
    class HellfirePeninsulaPvP : OutdoorPvP
    {
        ...
        public HellfirePeninsulaPvP(Map map) : base(map)
        {
            ...
            ControlZoneHandlers[(int)GameObjectIds.TowerS] = new HellfirePeninsulaControlZoneHandler(this);
            ...
            GetControlZoneTowerSouthHandler().SetKillCredit((int)KillCreditIds.TowerS);

            ControlZoneHandlers[(int)GameObjectIds.TowerN] = new HellfirePeninsulaControlZoneHandler(this);
            ...
            GetControlZoneTowerNorthHandler().SetKillCredit((int)KillCreditIds.TowerN);

            ControlZoneHandlers[(int)GameObjectIds.TowerW] = new HellfirePeninsulaControlZoneHandler(this);
            ...
            GetControlZoneTowerWestHandler().SetKillCredit((int)KillCreditIds.TowerW);
        }
        ...
        public override void Update(uint diff)
        {
            ...
            SetWorldState(WorldStateIds.CountH, m_HordeTowersControlled);
        }
    ...
    class HellfirePeninsulaControlZoneHandler : OutdoorPvPControlZoneHandler
    {
        ...
        int _textCaptureAlliance;
        int _textCaptureHorde;
        int _flagArtKitNeutral;
        int _flagArtKitHorde;
        int _flagArtKitAlliance;
        ...
        public void SetTextCaptureHorde(int text) { _textCaptureHorde = text; }
        public void SetTextCaptureAlliance(int text) { _textCaptureAlliance = text; }
        public void SetFlagArtKitNeutral(int artKit) { _flagArtKitNeutral = artKit; }
        public void SetFlagArtKitHorde(int artKit) { _flagArtKitHorde = artKit; }
        public void SetFlagArtKitAlliance(int artKit) { _flagArtKitAlliance = artKit; }
        ...
        public void SetKillCredit(int credit) { _killCredit = credit; }
